...
def run(
    ...
    openapi_title: Optional[str] = typer.Option("OpenAPI", "--title", "-t", envvar="openapi_title"),
    openapi_verison: Optional[str] = typer.Option("3.1.0", "--openapi-verison", envvar="openapi_verison"),
